...
const RESULTS = [
  ...
  { number: "100%", label: "routes admin protégées", detail: "Rôle + UUID + vérification serveur" },
...
const FAQ = [
  { q: "Pourquoi mon site a-t-il besoin d'un audit de sécurité ?", a: "La plupart des sites en production ont des failles invisibles : secrets exposés dans le code, routes admin accessibles, uploads non valides, headers manquants. Un audit identifie ces failles avant qu'un attaquant ne les exploite. C'est moins cher de prévenir que de gérer une fuite de données ou un site piraté." },
