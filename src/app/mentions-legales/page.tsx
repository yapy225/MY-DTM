    ...
    <section className="mx-auto max-w-3xl px-4 pt-32 pb-20 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted [&_h2]:mb-3 [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-dark">
        <div>
          ...
          <p>
            Le site <strong>my-dtm.fr</strong> est édité par My DTM, micro-entreprise immatriculée en France.
          </p>
        ...
        <div>
          ...
          <p>
            ...
            sont la propriété exclusive de My DTM ou de leurs auteurs respectifs.
        ...
        <div>
          ...
          <p>
            Les informations recueillies via le formulaire de contact sont destinées exclusivement à My DTM
        ...
        <div>
          ...
          <p>
            My DTM s&apos;efforce de fournir des informations exactes et à jour sur le site.
