...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    content: [
      { type: "p", text: "Depuis 2024, Google exige le Consent Mode v2 pour continuer à utiliser les données des audiences et des conversions dans l'Espace économique européen. Résultat : beaucoup d'entreprises se retrouvent coincées entre la conformité RGPD/CNIL et la peur de « perdre » leurs conversions. Bonne nouvelle : bien configuré, on peut respecter le consentement ET continuer à mesurer. Voici comment." },
      { type: "h2", text: "Qu'est-ce que le Consent Mode v2 ?" },
      { type: "p", text: "C'est un mécanisme de Google qui ajuste le comportement de ses balises (Google Ads, GA4) en fonction du consentement de l'internaute. Concrètement, votre bandeau cookies transmet aux balises des signaux (autorisé / refusé) pour deux nouveaux paramètres : le stockage des données publicitaires et l'usage des données utilisateur pour la publicité. Sans ces signaux, Google restreint les fonctionnalités marketing dans l'EEE." },
      { type: "h2", text: "Ce que demande la CNIL sur le bandeau cookies" },
      { type: "ul", items: [
        "Refuser doit être aussi simple qu'accepter (un bouton « Tout refuser » visible au premier niveau).",
        "Aucun dépôt de cookie non essentiel avant le consentement.",
        "Un choix libre, éclairé et par finalité, avec la possibilité de changer d'avis facilement.",
        "Conserver la preuve du consentement.",
      ]},
      { type: "h2", text: "Consent Mode v2 ne veut pas dire perdre ses conversions" },
      { type: "p", text: "C'est le point mal compris. Quand un internaute refuse, Google ne pose pas de cookie, mais reçoit des pings anonymes qui alimentent une modélisation des conversions : les conversions non observées sont estimées statistiquement. On mesure donc toujours une tendance fiable, sans suivre individuellement les personnes qui ont refusé. Pour aller plus loin, on peut coupler le Consent Mode au suivi côté serveur (server-side) et à l'API Conversions de Meta." },
      ...
      { type: "ul", items: [
        "Une CMP (plateforme de gestion du consentement) conforme, branchée sur Google Tag Manager.",
        "Le Consent Mode v2 activé, avec les paramètres ad_storage, analytics_storage, ad_user_data et ad_personalization.",
        "Des balises qui ne se déclenchent qu'après le signal de consentement.",
        "Idéalement, un suivi server-side pour fiabiliser la mesure tout en respectant les choix des utilisateurs.",
      ]},
      { type: "p", text: "La conformité n'est pas l'ennemie de la performance : c'est une question de configuration. Bien réglé, votre tracking respecte le RGPD, satisfait la CNIL et continue de nourrir vos campagnes en données exploitables." },
    ],
  },
  {
